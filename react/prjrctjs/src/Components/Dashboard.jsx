              ...
              <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav flex-column">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="Dashboard">
                      {" "}
                      <FontAwesomeIcon icon={faCircleUser} size="xl" /> Users
                    </a>
                  </li>
                  <li className="nav-item">
          ...
          <div className="col-8">
            <div className="container-fluid container-fluid d-flex justify-content-between">
              ...
              <form className="Nav" role="search">
                ...
                <button onClick={() => setIsModalOpen(true)} className="box">
                  <img
                    className="prof"
                    src={profile}
                    alt="profileimage"
                ...
                {/* <button className="close" onClick={() => setShowPopup(true)} style={{backgroundColor:"transparent",borderStyle:"none",outlineStyle:'none'}}>  </button>
        <Modal/>             */}
              </form>
            </div>
          </div>
